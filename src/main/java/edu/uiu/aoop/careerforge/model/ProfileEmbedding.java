...
/** Persisted semantic vector for a student's current profile. */
@Entity
...
public class ProfileEmbedding {
    ...
    protected ProfileEmbedding() { }
    public ProfileEmbedding(Long userId) { this.userId = userId; this.status = "pending"; this.vectorJson = "[]"; }
