...
public class LearningPathController {
    ...
    @PostMapping("/{pathId}/levels/{levelNumber}/regenerate") public LearningQuizResponse regenerate(@RequestHeader(name = "X-User-Id", required = false) Long userId, @PathVariable Long pathId, @PathVariable int levelNumber) { return learningPaths.regenerate(userId, pathId, levelNumber); }
