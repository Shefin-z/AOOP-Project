...
export function StudentResources() {
  ...
  return <section className="student-resources">
    ...
    <section className="skill-resource-finder">
      <p className="eyebrow"><Youtube size={15} /> SKILL RESOURCE FINDER</p><h3>What skill do you want to gain?</h3><p>Search a skill for five top English, Hindi, and Bangla YouTube playlists. A matching resource selected by your CareerForge administrator always appears first.</p>
