...
export function StudentResources() {
  ...
  return <section className="student-resources">
    ...
    <section className="skill-resource-finder">
      ...
      <form onSubmit={findSkill}><label><Search size={20} /><input value={skill} onChange={(event) => setSkill(event.target.value)} /></label><button disabled={searching || !skill.trim()} type="submit"><Search size={16} /> Search videos</button></form>
