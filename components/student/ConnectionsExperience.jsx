    ...
    <div className="space-y-5">
      ...
      <section className="grid gap-5 xl:grid-cols-[minmax(320px,.86fr)_minmax(0,1.35fr)]">
        ...
        <section className="panel flex min-h-[620px] flex-col overflow-hidden p-0">
          ...
          {selectedConnection && <>
            <header className="flex items-center gap-3 border-b border-ink/[0.07] bg-white/45 px-5 py-4 dark:bg-white/[0.025]">
            ...
            <div className="flex-1 space-y-3 overflow-y-auto bg-canvas/45 px-5 py-5">
