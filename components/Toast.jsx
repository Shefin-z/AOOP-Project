...
export default function Toast({ message, onClose }) {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[100] flex max-w-sm animate-enter items-center gap-3 rounded-2xl border border-white/70 bg-ink px-4 py-3 text-sm font-semibold text-white shadow-lift" role="status">
